          ...
          <div className="flex flex-col items-start">
            ...
            <div className="w-full">
              <div className="relative w-full max-w-md">
                ...
                />
                <button className="absolute top-1/2 right-1 md:right-2 -translate-y-1/2 px-4 md:px-5 py-1.5 md:py-2 my-button text-white rounded-full  transition-all duration-200 text-sm md:text-base">
                  Subscribe
                </button>
              </div>
            </div>
...
<<<<<<< HEAD
            ...
            <div className="flex gap-3 md:gap-4">
              <a
                href="#"
                className="w-10 h-10 md:w-12 md:h-12 my-button rounded-full flex items-center justify-center transition-colors"
              >
                <Image src={Facebook || "/placeholder.svg"} alt="Facebook" className="w-4 h-4 md:w-5 md:h-5" />
              </a>
              <a
                href="#"
                className="w-10 h-10 md:w-12 md:h-12 my-button rounded-full flex items-center justify-center transition-colors"
              >
                <Image src={Instagram || "/placeholder.svg"} alt="Instagram" className="w-4 h-4 md:w-5 md:h-5" />
              </a>
              <a
                href="#"
                className="w-10 h-10 md:w-12 md:h-12 my-button rounded-full flex items-center justify-center transition-colors"
              >
                <Image src={Linkedin || "/placeholder.svg"} alt="LinkedIn" className="w-4 h-4 md:w-5 md:h-5" />
              </a>
=======
            <motion.div
