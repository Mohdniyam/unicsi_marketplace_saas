    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-0 min-h-[auto] lg:min-h-[500px]" >
        <div className="w-full lg:w-1/2 relative">
          ...
          <Image src={Services || "/placeholder.svg"} alt="Services" className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-full" />
        </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-between lg:pl-12">
          ...
          <div className="mt-6 sm:mt-8 md:mt-10">
            <Button
              className="my-button text-base sm:text-lg md:text-xl py-3 sm:py-4 md:py-5 w-full sm:w-auto"
              style={{
                borderRadius: "50px",
                paddingLeft: "24px",
                paddingRight: "24px",
